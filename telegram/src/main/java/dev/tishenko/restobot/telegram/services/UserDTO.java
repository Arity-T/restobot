 ...
 * <p>
 * Contains user identification, location, preferred kitchen types, price categories,
 * search keywords, and a list of favorite restaurant cards.
 * </p>
 *
...
public record UserDTO(
        ...
        List<RestaurantCardDTO> favoriteList
) {
}