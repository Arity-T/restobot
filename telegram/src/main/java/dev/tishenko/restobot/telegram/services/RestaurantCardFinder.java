...
/**
 * Service interface for locating restaurant cards based on various search criteria. Provides
 * methods to retrieve restaurant data by geographic coordinates or by custom parameters.
 *
 * <p>Parameter "Любые" means that the user can choose any restaurant according to this criterion.
