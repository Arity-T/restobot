...
Добавь в jenkinsfile создание jenkins node в виде следующего сервера:
```
Host labs
  HostName 192.168.199.107
  User ubuntu
  IdentityFile C:\Users\gaarv\.ssh\id_ed25519_labs
```

На этом сервере должна производиться сборка и архивация артефакта.
